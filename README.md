...
[travis-badge]: https://travis-ci.org/filipesilva/angular-@rd/core.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-@rd/core
...
1. Create a project folder (you can call it `@rd/core` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-@rd/core.git
cd angular-@rd/core
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-@rd/core/archive/master.zip)
...
Use your editor to search the project for all instances of `@rd/core` and change it
